...
```{tex}
# Existe un dato atípico, el cual es el gen LUSC, esto quiere decir que existe sobreexpresión en ese gen, 
# Como además otro gen que está en tendencia hacia una sobrexpresión genética como el gen mencionado anteriormente.
